...
<head>
    ...
    <link rel="stylesheet" href="/src/main/webapp/resources/css/EDMS/EDMS_end.css">
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseEDMS" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="../EDMS/EDMS_end.html">완료문서</a>                    
                            </nav>
                        </div>
                ...
                <div class="EDMS_end_list_number">
                    <div>
                        <div class="EDMS_end_list_n_menu">
                            <span class="EDMS_end_disabled"><  이전</span>
                            <span class="EDMS_end_current">1</span>
                            <a href="#?page=2">2</a>
                            <a href="#?page=3">3</a>
                            <a href="#?page=4">4</a>
                            <a href="#?page=5">5</a>
                            ...
                            <a href="#?page=7">9</a>
                            <a href="#?page=7">10</a>
                            <span class="EDMS_end_disabled">다음  ></span>                                
                        </div>                            
                    </div>
                </div>
        </div>
