...
<head>
    ...
    <link rel="stylesheet" href="/src/main/webapp/resources/css/EDMS/EDMS_wait.css">
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseEDMS" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="EDMS_Temporary_box.jsp">임시보관함</a>
                                <a class="nav-link" href="../EDMS/EDMS_wait.html">결재대기중</a>
        ...
        <div id="layoutSidenav_content">
            ...
            <div class="EDMS_wait_docu_list">
                ...
                <table class="EDMS_wait_docu_table">
                    ...
                    <tr class="EDMS_wait_table_hover">
                        <td>20203086</td>
                        <td>2021-12-10</td>
                        <td>품의서</td>
                        <td>김형준</td>
                    ...
                    <div class="EDMS_wait_list_number">
                        <div>
                            <div class="EDMS_wait_list_n_menu">
                                <span class="EDMS_wait_disabled"><  이전</span>
                                <span class="EDMS_wait_current">1</span>
                                <a href="#?page=2">2</a>
                                <a href="#?page=3">3</a>
                                <span class="EDMS_wait_disabled">다음  ></span>                                
                            </div>                            
                        </div>
                    </div>
        </div>
