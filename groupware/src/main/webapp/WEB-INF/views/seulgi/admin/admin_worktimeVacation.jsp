...
<div id="layoutSidenav_content">
    ...
    <div class="admin_worktime_container">
        <div class="admin_worktime_sidebar">
            <div><a href="../admin/admin_worktime.html">출퇴근시간관리</a></div>
            <div><a href="../admin/admin_worktime_vacation.html">연차일수관리</a></div>
        </div>
...
<script src="<c:url value="/resources/js/admin/admin_worktimeVacation.js"/>"></script>
